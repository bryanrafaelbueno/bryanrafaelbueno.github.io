# Bryan Rafael | Portfolio

A bilingual, responsive portfolio for Bryan Rafael Bueno Ribeiro. The site is intentionally static so it is fast, easy to maintain, and ready for GitHub Pages, Netlify, Vercel, or any basic web host.
